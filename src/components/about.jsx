        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have experience building SPAs using React, HTML, && CSS</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>Enjoy building and recreating patterns that only Node, Express, and Python can provide. </p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>Familiar with SQL and Mongo DB</p>
                </div>
                </div>
            </div>
